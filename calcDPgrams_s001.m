%% script which calculates DPgrams for s001 for f2/f1 = 1.11
% there are two level paradigms
% 1. L2 = 50 or L2 = 55 dB FPL and L1 varied
% 2. L1 = 50 or L1 = 55 dB FPL and L2 varied
...
pathname = 'Experiments/s001/r111/L2const'
FldInf = dir(pathname);
...
pathname = 'Experiments/s001/r111/L1const'
FldInf = dir(pathname);
...
for k=1:length(L2var)
    ...
    for j=1:size(FldInf,1)
        ...
        L1loc = strfind(FldInf(j).name,['L1_' num2str(L1)]);
        L2loc = strfind(FldInf(j).name,['L2_' num2str(L2var(k))]);
    ...
    if length(recMean)>1
        ...
        L1o = L1var(k);
        L2o = L2;
        save([pathname '/DPgrams/dpgrL1_' num2str(L1) 'dB_L2_' num2str(L2var(k)) 'dB.mat'],'freq','f2f1','L2o','L1o','Poae','Nfloor','RMSerr');
    end
end
