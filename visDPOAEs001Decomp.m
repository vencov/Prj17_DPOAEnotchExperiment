...
if build
    ...
    FileNames = dir('Experiments/s001/r111/L2const/DPgrams/');
    ...
    FileNames = dir('Experiments/s001/r111/L1const/DPgrams/');
    ...
    for k=1:size(DPgrL1c50,2)
        ...
        [fxL1_50, DPgAlla, DPgNLa, DPgCRa, DPgCR1a, DPgAllreca, DPgAllph, DPgNLph, DPgCRph, DPgCR1ph, DPgAllrecph, ...
            fc, DPtoctAlla, DPtoctNLa, DPtoctCRa,wlgraph] = WLTdecompFCE(parW,1000*f2r150,DPgrL1c50(:,k).',plotflag);
        ...
        [fxL1_50, DPgAlla, DPgNLa, DPgCRa, DPgCR1a, DPgAllreca, DPgAllph, DPgNLph, DPgCRph, DPgCR1ph, DPgAllrecph, ...
            fc, DPtoctAlla, DPtoctNLa, DPtoctCRa,wlgraph] = WLTdecompFCE(parW,1000*f2r150,NFgrL1c50(:,k).',plotflag);
        NFdecL1c50NLa(:,k) = DPgNLa;
    end
    
    for k=1:size(DPgrL1c55,2)
        [fxL1_55, DPgAlla, DPgNLa, DPgCRa, DPgCR1a, DPgAllreca, DPgAllph, DPgNLph, DPgCRph, DPgCR1ph, DPgAllrecph, ...
            fc, DPtoctAlla, DPtoctNLa, DPtoctCRa,wlgraph] = WLTdecompFCE(parW,1000*f2r155,DPgrL1c55(:,k).',plotflag);
        ...
        [fxL1_55, DPgAlla, DPgNLa, DPgCRa, DPgCR1a, DPgAllreca, DPgAllph, DPgNLph, DPgCRph, DPgCR1ph, DPgAllrecph, ...
            fc, DPtoctAlla, DPtoctNLa, DPtoctCRa,wlgraph] = WLTdecompFCE(parW,1000*f2r155,NFgrL1c55(:,k).',plotflag);
...
decL2c55NLphU = decL2c55NLph/cycle;
decL2c50NLphU = decL2c50NLph/cycle;
decL1c50NLphU = decL1c50NLph/cycle;
decL1c55NLphU = decL1c55NLph/cycle;
...
PhLim = [-2 1];
% subplot(2,2,1);
% a1 = surf(fx,L1i50,decL2c50NLaI'); shading flat; view([0 90])
% subplot(2,2,3);
% surf(fx,L1i50,decL2c50NLphUI'); shading flat; view([0 90])
% zlim(PhLim);
% caxis(PhLim);
...
text(4150,49,'Amplitude (dB SPL)','fontsize',iFontSize,'fontname',strFontName,'rotation',-90,'horizontalalignment','center');
f2s_1 = 1300;
f2s_2 = 2800;
f2s_3 = 3600;
...
text(2200,61.3,'{\itL}_2 = 50 dB','backgroundcolor','white','fontsize',iFontSize-2)
text(1000,61,'A','fontsize',iFontSize+3,'fontname',strFontName,'rotation',0,'horizontalalignment','center','fontweight','bold');
text(4600,61,'B','fontsize',iFontSize+3,'fontname',strFontName,'rotation',0,'horizontalalignment','center','fontweight','bold');
text(9000,61,'C','fontsize',iFontSize+3,'fontname',strFontName,'rotation',0,'horizontalalignment','center','fontweight','bold');
text(13400,61,'D','fontsize',iFontSize+3,'fontname',strFontName,'rotation',0,'horizontalalignment','center','fontweight','bold');
set(haR1A1,...
...
text(2150,58,'{\itL}_2 = 55 dB','backgroundcolor','white','fontsize',iFontSize-2)
...
plot(L1var55(2:end),unwrap(decL2c55NLph(idxF2_1,2:end))/cycle+1,'kx-','linewidth',LW,'markersize',MS);
plot(L1var50,unwrap(decL2c50CRph(idxF2_1,:))/cycle+1,'ro:','linewidth',LW-0.3,'markersize',MS);
plot(L1var55(2:end),unwrap(decL2c55CRph(idxF2_1,2:end))/cycle+1,'rx:','linewidth',LW-0.3,'markersize',MS);


legend({['{\itL}_2 = ' num2str(50) ' dB'], ['{\itL}_2 = 55 dB']},...
    'position',[0.38 0.943 0.07 0.04],'fontsize',iFontSize-2,'orientation','horizontal');
...
text(4010,39,'Amplitude (dB SPL)','fontsize',iFontSize,'fontname',strFontName,'rotation',-90,'horizontalalignment','center');
f2s_1 = 1300;
f2s_2 = 2800;
f2s_3 = 3600;
...
text(2290,49.1,'{\itL}_1 = 50 dB','backgroundcolor','white','fontsize',iFontSize-2)

set(haR1A2,...
    'ticklength',[0.03 0.01],...
    'fontsize',iFontSize,...
    'ytick',[40,42,44,46,48],...
    'xtick',[1000,2000,3000,4000],...
    'ylim',[40 48],...
    'xlim',[1000,3300],...
    'xticklabel','',...
...
text(450,37,'{\itL}_2 (dB FPL)','fontsize',iFontSize,'rotation',90,'fontname',strFontName );
...
idxF2_1 = find(fxL1_55>=f2s_1,1,'first');
idxF2_2 = find(fxL1_55>=f2s_2,1,'first');
idxF2_3 = find(fxL1_55>=f2s_3,1,'first');
...
text(2290,44.0,'{\itL}_1 = 55 dB','backgroundcolor','white','fontsize',iFontSize-2)
...
plot(L2var55(1:end-1),decL1c55NLa(idxF2_1,1:end-1),'kx-','linewidth',LW,'markersize',MS);
plot(L2var50,decL1c50CRa(idxF2_1,:),'ro:','linewidth',LW-0.3,'markersize',MS);
plot(L2var55(1:end-1),decL1c55CRa(idxF2_1,1:end-1),'rx:','linewidth',LW-0.3,'markersize',MS);

plot(L2var50,NFdecL1c50NLa(idxF2_1,:),'k+:','linewidth',LW-0.5,'markersize',MS);
plot(L2var55(1:end-1),NFdecL1c55NLa(idxF2_1,1:end-1),'kx:','linewidth',LW-0.5,'markersize',MS);
...
% errenous unwrapping compensated by addint [0.5,0,0....] to all data
plot(L2var50,unwrap(decL1c50NLph(idxF2_1,:))/cycle,'ko-','linewidth',LW,'markersize',MS);
plot(L2var55(1:end-1),unwrap(decL1c55NLph(idxF2_1,1:end-1))/cycle,'kx-','linewidth',LW,'markersize',MS);
plot(L2var50,unwrap(decL1c50CRph(idxF2_1,:))/cycle,'ro:','linewidth',LW-0.3,'markersize',MS);
plot(L2var55(1:end-1),unwrap(decL1c55CRph(idxF2_1,1:end-1))/cycle,'rx:','linewidth',LW-0.3,'markersize',MS);
...
legend({['{\itL}_1 = ' num2str(50) ' dB'], ['{\itL}_1 = 55 dB']},...
    'position',[0.88 0.92 0.07 0.04],'fontsize',iFontSize-2,'orientation','vertical');


iResolution = 600;
strFileName = ['Figures/s001L1L2const'];
